    ...
    >
      ...
      <div className="w-full lgl:w-1/2">
        <div className="flex flex-col gap-4 py-12 font-titleFont">
          ...
          <h1 className="text-3xl font-bold md:text-4xl">Development Skill</h1>
        </div>
        <div className="flex flex-col gap-6">
          <div className="overflow-x-hidden">
            <p className="text-sm font-medium uppercase">JavaSscript</p>
            <span className="inline-flex w-full h-2 mt-2 bg-gray-700 rounded-md">
              <motion.span
                initial={{ x: "-100%", opacity: 0 }}
                animate={{ x: 0, opacity: 1 }}
          ...
          <div className="overflow-x-hidden">
            ...
            <span className="inline-flex w-full h-2 mt-2 bg-gray-700 rounded-md">
              <motion.span
                ...
                animate={{ x: 0, opacity: 1 }}
                transition={{ duration: 0.5, delay: 0.5 }}
                className="relative w-[65%] h-full rounded-md bg-gradient-to-r from-blue-600 via-pink-500 to-red-500"
              >
          ...
          <div className="overflow-x-hidden">
            ...
            <span className="inline-flex w-full h-2 mt-2 bg-gray-700 rounded-md">
              <motion.span
                ...
                animate={{ x: 0, opacity: 1 }}
                transition={{ duration: 0.5, delay: 0.5 }}
                className="relative w-[40%] h-full rounded-md bg-gradient-to-r from-blue-600 via-pink-500 to-red-500"
              >
                <span className="absolute right-0 -top-7">40%</span>
              </motion.span>
            </span>
          </div>
          <div className="overflow-x-hidden">
